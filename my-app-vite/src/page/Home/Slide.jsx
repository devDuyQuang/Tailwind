...
export default function Slide() {
  ...
  const baseSlides = [
    {
      ...
      kickerClass: "",
      titleClass: "text-[100px] leading-[105px]", // chỉnh to/nhỏ tại đây
      descClass: "",
      imgBoxClass: "",
      imgClass: "",
      leftMaxW: "",
    },
    {
      ...
      desc: "Hương vị được tuyển chọn kỹ lưỡng cùng bí quyết ủ bia tạo nên trải nghiệm sảng khoái đặc trưng Thúc đẩy một thông điệp về sự tự do lựa chọn, cho phép mọi người thưởng thức đồ uống có cồn hoặc không cồn một cách linh hoạt, tùy thuộc vào hoàn cảnh và sở thích cá nhân.",
      kickerClass: "",
      titleClass: "text-[100px] leading-[105px]",
      descClass: "",
      imgBoxClass: "",
      imgClass: "",
      leftMaxW: "",
    },
    {
      ...
      kickerClass: "",
      titleClass: "text-[100px] leading-[99px]",
      descClass: "",
      imgBoxClass: "",
      imgClass: "",
      leftMaxW: "",
  ...
  // interval rất lớn -> gần như đứng yên, chỉ đổi khi bấm dot
  const interval = 6000;
                  ...
                  <div className="grid items-center gap-[32px] grid-cols-1 lg:grid-cols-[1fr_672px]">
                    ...
                    >
                      ...
                      {hasCustomLines ? (
                        ...
                        <h1
                          className={`${titleBase} ${
                            s.titleClass || "text-[100px] leading-[105px]"
                          }`}
                          style={{
