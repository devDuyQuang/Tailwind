...
export default function HeaderMobile() {
  ...
  // ---- Config ngôn ngữ (một nơi duy nhất) ----
  const LANGS = {
  ...
  // Chuẩn hóa code đang dùng (nhận cả 'cz' -> 'cs')
      ...
      {open && (
        <div className="fixed inset-0 z-50">
          ...
          >
            ...
            {/* ===== BODY: vùng cuộn (KHÔNG padding) ===== */}
            <div className="flex-1 overflow-y-auto">
              {/* Padding 16px đặt Ở TRONG để canh thẳng nút X */}
              <div className="pl-4 pr-4">
                {/* Khung Content 300×389 – căn trái thẳng hàng với nút X */}
                <div className="w-[300px] h-[389px] flex flex-col justify-center items-start py-6 gap-2">
                  {/* Nav items + underline ở từ đầu tiên */}
                  {NAV.map(({ label, to }) => {
                  ...
                  {/* Language row – chỉ hiển thị NGÔN NGỮ KHÁC */}
            ...
            {/* ===== FOOTER CTA (khung riêng, bám đáy) ===== */}
